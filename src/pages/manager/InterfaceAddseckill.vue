<template>
  <div class="interfaceaddseckill">
    <div class="addseckillheader">
      添加秒杀商品
    </div>
    ...
    <div class="addseckillfooter">
      <button class="addseckillbutton"
...
export default {
  ...
  methods: {
    outputtime () {
      ...
      //发送post请求登录
      this.$http.post('manage/addSeckillGoods', this.$qs.stringify(data)).then(
        response => {
          console.log(data)
